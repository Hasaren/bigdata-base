"""
다른 페이지에서 st.sesstion_state에 저장해둔 값들을 여기서 그대로 읽어올 수 있는지 확인
--> st.sesstion_state가 페이지를 넘어가도 유지된다는 점을 알아두자.
"""
